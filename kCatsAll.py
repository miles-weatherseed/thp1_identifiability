...
class inferenceModel(pints.ForwardModel):
    ...
    def simulate(self, params, times):
        params = np.multiply(np.asarray([2694.91, 400, 12, 0.0000027, 12, 400/60, 33/60, 58.8/60, 400/60, 400000/18000, 400000/18000, 400000/18000, 400000/18000, 400000/18000]), np.hstack([np.ones(2), params[0], 1, params[1:], np.ones(5)]))
